...
driver = webdriver.Chrome(
    "C:\\Users\\Nikhil Tayal\\Web Driver\\chromedriver.exe")
...
driver.find_element_by_xpath("//select[@name='asYear']/option[text()='2018-19']").click()
driver.implicitly_wait(1)

driver.find_element_by_xpath("//select[@name='formId']/option[text()='ITR-1']").click()
download_link.click()
...
driver.find_element_by_css_selector(".ui-dialog.ui-widget>#prefillConcentDialog>div>#UpdateContactDtls_0.btnOrange").click() # Continue
